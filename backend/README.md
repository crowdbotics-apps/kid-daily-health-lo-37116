...
## Project Structure
    ...
    ├── kid_daily_health_lo_37116  # Django project configurations
...
1. Clone this repo and `cd kid_daily_health_lo_37116`
...
2. Clone this repo and `cd kid_daily_health_lo_37116`
